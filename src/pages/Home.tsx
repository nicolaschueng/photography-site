...
export default function Home() {
  ...
  return (
    <div className="page-enter">
      ...
      <section className="mx-auto max-w-3xl px-5 sm:px-6 md:px-10 pt-10 sm:pt-16 md:pt-24 pb-10 sm:pb-14 md:pb-20 text-center">
        ...
        <h1 className="mt-6 sm:mt-8 font-display text-xl sm:text-2xl md:text-3xl tracking-tight">
          Dirty_Sheep
        </h1>

        <p className="signature mt-6 sm:mt-8 text-lg sm:text-xl md:text-2xl opacity-90">
          "漫漫人生路,瞎搞搞如何"
        </p>
      ...
      {/* Collections grid */}
      <section className="mx-auto max-w-6xl px-5 sm:px-6 md:px-10 pb-10">
        <div className="mb-8 sm:mb-10 md:mb-12 flex flex-col items-center gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 md:gap-x-8 gap-y-12 sm:gap-y-16 md:gap-y-20">
          {list.map((c, i) => (
...
function CollectionCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-5 flex items-baseline justify-between gap-3 sm:gap-4">
        <div className="min-w-0">
          <h3 className="font-display text-lg sm:text-xl md:text-2xl tracking-tight truncate">
            {title}
          </h3>
          <p className="mt-1 text-[13px] sm:text-[14px] italic opacity-70 truncate">{subtitle}</p>
        </div>
